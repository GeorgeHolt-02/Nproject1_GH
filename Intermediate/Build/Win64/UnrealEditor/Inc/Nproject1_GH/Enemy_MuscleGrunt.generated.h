...
class AActor;
struct FHitResult;
#ifdef NPROJECT1_GH_Enemy_MuscleGrunt_generated_h
#error "Enemy_MuscleGrunt.generated.h already included, missing '#pragma once' in Enemy_MuscleGrunt.h"
#endif
...
public: \
	DECLARE_CLASS(AEnemy_MuscleGrunt, ABaseEnemy, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Nproject1_GH"), NO_API) \
...
#define FID_Nproject1_GH_Source_Nproject1_GH_Enemy_MuscleGrunt_h_16_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AEnemy_MuscleGrunt); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AEnemy_MuscleGrunt); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AEnemy_MuscleGrunt(AEnemy_MuscleGrunt&&); \
	NO_API AEnemy_MuscleGrunt(const AEnemy_MuscleGrunt&); \
public:
...
template<> NPROJECT1_GH_API UClass* StaticClass<class AEnemy_MuscleGrunt>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_Nproject1_GH_Source_Nproject1_GH_Enemy_MuscleGrunt_h
